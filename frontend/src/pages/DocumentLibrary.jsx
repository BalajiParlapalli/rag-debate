...
export default function DocumentLibrary({ docs, onUpload }) {
  ...
  return (
    <div>
      ...
      <p style={{ margin: "0 0 28px", color: "#6b6b75", fontSize: 14 }}>Upload PDFs to build your debate corpus.</p>

      <label style={{
        display: "inline-flex", alignItems: "center", gap: 10,
        padding: "12px 20px", borderRadius: 8, border: "1px dashed #3a3a44",
        cursor: uploading ? "not-allowed" : "pointer", color: uploading ? "#444" : "#a5b4fc", fontSize: 14, marginBottom: 24,
      }}>
        <span>📤</span>
            ...
            <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 18px", background: "#18181c", border: "1px solid #2a2a30", borderRadius: 8 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "#6b6b75" }}>Indexed ✓</div>
                </div>
              </div>
